...
function editAddress(addressId,name, houseName, street, city, state, pincode, phone,altPhone = '') {
    ...
    document.getElementById('addAddressForm').action = `/checkout/editAddress/${addressId}`
    // ?page=${currentPage}`

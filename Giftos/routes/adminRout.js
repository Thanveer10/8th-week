...
admin_router.get('/admin-profile',adminAuth,admin_ctrl.adminProfile)
admin_router.get('/edit-adminProfile',adminAuth,admin_ctrl.adminProfileUpdateget)
admin_router.post('/edit-adminProfile',adminAuth,admin_ctrl.adminProfileUpdate)
admin_router.get('/editPassword',adminAuth,admin_ctrl.editPasswordget)
admin_router.post('/editPassword',adminAuth,admin_ctrl.editPasswordPost)
